...
<html>
    ...
    <body>         
        ...
        <div class="big-div">
            <label class="label-discreption1">Health</label>
            <label class="label-discreption1">How do we help each other?</label>                                       
        </div>
        <form action="../Controller/HealthController.php" method="POST" style="display: inline">
            <div class="small-div">
                <label>Have you recovered from corona (COVID-19) virus ? <span style="color: #d93025; font-size: 15px;">*</span></label>
                <div>
                    <input type="radio" id="yes" name="recovered" value="Yes" style=" margin-left: 20px; margin-top: 25px;">
                    <label style="display: inline;">Yes</label><br>
                    <input type="radio" id="no" name="recovered" value="No" style=" margin-left: 20px; margin-top: 15px;">
